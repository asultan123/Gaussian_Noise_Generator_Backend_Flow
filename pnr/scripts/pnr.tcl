...
create_floorplan -core_utilization 0.25 \
	...
	-left_io2core 13.1 -bottom_io2core 13.1 -right_io2core 13.1 -top_io2core 13.1
...
## Define Power Mesh 
####################
set_fp_rail_constraints -add_layer  -layer metal10 -direction vertical   -max_strap 128 -min_strap 20 -min_width 2.5 -spacing 1.5 
set_fp_rail_constraints -add_layer  -layer metal9  -direction horizontal -max_strap 128 -min_strap 20 -min_width 2.5 -spacing 1.5 
set_fp_rail_constraints -add_layer  -layer metal8  -direction vertical   -max_strap 128 -min_strap 20 -min_width 2.5 -spacing 1.5
set_fp_rail_constraints -add_layer  -layer metal7  -direction horizontal -max_strap 128 -min_strap 20 -min_width 2.5 -spacing 1.5
set_fp_rail_constraints -add_layer  -layer metal6  -direction vertical   -max_strap 128 -min_strap 20 -min_width 2.5 -spacing 1.5
...
## Tie fixed values
set tie_pins [get_pins -hier -all -filter "constant_value == 0 || constant_value == 1 && name !~ V* && is_hierarchical == false "]
...
## To avoid NDR at clock sinks prevents larger widths for local routes
...
save_mw_cel -as ${design}_3_useclock_for_hold
## 2- CTO
...
#Use the following two commands to check and fix the remaining DRC violations.
verify_zrt_route
...
# set verilog naming rule
define_name_rules  port_name_rules -equal_ports_nets
change_names -rule port_name_rules -hierarchy
define_name_rules  no_case -case_sensitive
